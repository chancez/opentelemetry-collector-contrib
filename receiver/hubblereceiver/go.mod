module github.com/open-telemetry/opentelemetry-collector-contrib/receiver/hubblereceiver
...
require (
	...
	github.com/cilium/hubble-ui/backend v0.0.0-20220910050645-8e7efecc1af2
